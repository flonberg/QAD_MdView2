...
ob_start(); var_dump($handleBB);$data = ob_get_clean();fwrite($fp, "\r\n handleBB  is  \r\n ". $data);  
ob_start(); var_dump($handleMQ);$data = ob_get_clean();fwrite($fp, "\r\n handleMQ  is  \r\n ". $data);  
...
function getFromNewData(){
  ...
  fwrite($fp, "\r\n  $i  130130 new Plans plans retrieved \r\n");
...
fwrite($fp, "\r\n 155 \r\n");  
  ...
  $rData['inst'] = getInsts();
  ob_start(); var_dump($rData);$data = ob_get_clean();fwrite($fp, "\r\n rData  is  \r\n ". $data); 
$dstr = print_r($rData, true); fwrite($fp, " rData is \r\n". $dstr);   
  return $rData;
